    ...
    with open(a_path, 'r') as f:
        for line in f:
            if line.startswith('(step '):
                ...
                # Run carcara slice (suppress stdout)
                slice_cmd = ['carcara', 'slice', str(a_path), str(s_path),
                ...
                if returncode != 0:
                    ...
                    if output == "valid":
                        ...
                        invalids.append(f"INVALID: {a_path} {s_path} {step_id}\n")
                    elif output == "holey":
