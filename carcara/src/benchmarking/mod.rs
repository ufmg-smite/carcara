...
where
    ...
    ByPolyeq: Metrics<(), usize> + Default + Clone,
{
    fn new() -> Self {
        Default::default()
    }
        ...
        Self: Sized,
    {
        ...
        self.polyeq_time = other.polyeq_time.clone();
        self.polyeq_time_ratio = other.polyeq_time_ratio.clone();
        ...
        self.polyeq_depths = other.polyeq_depths.clone();
