...
pub fn not_not(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    ...
    let p = match_term_flat_err!((not (not (not p))) = &conclusion[0])?;
...
pub fn and_pos(RuleArgs { conclusion, args, .. }: RuleArgs) -> RuleResult {
    ...
    let and_contents = match_term_flat_err!((not (and ...)) = &conclusion[0])?;
...
pub fn and_neg(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    ...
    let and_contents = match_term_flat_err!((and ...) = &conclusion[0])?;
...
pub fn or_pos(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    ...
    let or_contents = match_term_flat_err!((not (or ...)) = &conclusion[0])?;
...
pub fn or_neg(RuleArgs { conclusion, args, .. }: RuleArgs) -> RuleResult {
    ...
    let or_contents = match_term_flat_err!((or ...) = &conclusion[0])?;
...
pub fn xor_pos1(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    ...
    let (phi_1, phi_2) = match_term_flat_err!((not (xor phi_1 phi_2)) = &conclusion[0])?;
...
pub fn xor_neg1(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    assert_clause_len(conclusion, 3)?;
    let (phi_1, phi_2) = match_term_flat_err!((xor phi_1 phi_2) = &conclusion[0])?;
    assert_eq(phi_1, &conclusion[1])?;
    assert_eq(phi_2, conclusion[2].remove_negation_err()?)
}
...
pub fn implies_pos(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    assert_clause_len(conclusion, 3)?;
    let (phi_1, phi_2) = match_term_flat_err!((not (=> phi_1 phi_2)) = &conclusion[0])?;
    assert_eq(phi_1, conclusion[1].remove_negation_err()?)?;
    assert_eq(phi_2, &conclusion[2])
}
...
pub fn implies_neg1(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    assert_clause_len(conclusion, 2)?;
    let (phi_1, _) = match_term_flat_err!((=> phi_1 phi_2) = &conclusion[0])?;
    assert_eq(phi_1, &conclusion[1])
}

pub fn implies_neg2(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    assert_clause_len(conclusion, 2)?;
    let (_, phi_2) = match_term_flat_err!((=> phi_1 phi_2) = &conclusion[0])?;
...
pub fn equiv_neg1(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    assert_clause_len(conclusion, 3)?;
    let (phi_1, phi_2) = match_term_flat_err!((= phi_1 phi_2) = &conclusion[0])?;
    assert_eq(phi_1, conclusion[1].remove_negation_err()?)?;
    assert_eq(phi_2, conclusion[2].remove_negation_err()?)
}
...
pub fn ite_pos1(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    assert_clause_len(conclusion, 3)?;
    let (phi_1, _, phi_3) = match_term_flat_err!((not (ite phi_1 phi_2 phi_3)) = &conclusion[0])?;
    assert_eq(phi_1, &conclusion[1])?;
...
pub fn ite_pos2(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    assert_clause_len(conclusion, 3)?;
    let (phi_1, phi_2, _) = match_term_flat_err!((not (ite phi_1 phi_2 phi_3)) = &conclusion[0])?;
    assert_eq(phi_1, conclusion[1].remove_negation_err()?)?;
    assert_eq(phi_2, &conclusion[2])
}
...
pub fn ite_neg1(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    assert_clause_len(conclusion, 3)?;
    let (phi_1, _, phi_3) = match_term_flat_err!((ite phi_1 phi_2 phi_3) = &conclusion[0])?;
    assert_eq(phi_1, &conclusion[1])?;
...
pub fn ite_neg2(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    assert_clause_len(conclusion, 3)?;
    let (phi_1, phi_2, _) = match_term_flat_err!((ite phi_1 phi_2 phi_3) = &conclusion[0])?;
    assert_eq(phi_1, conclusion[1].remove_negation_err()?)?;
    assert_eq(phi_2, conclusion[2].remove_negation_err()?)
}
...
pub fn equiv1(RuleArgs { conclusion, premises, .. }: RuleArgs) -> RuleResult {
    ...
    let (phi_1, phi_2) = match_term_flat_err!((= phi_1 phi_2) = premise_term)?;
...
pub fn not_equiv1(RuleArgs { conclusion, premises, .. }: RuleArgs) -> RuleResult {
    ...
    assert_clause_len(conclusion, 2)?;
    let premise_term = get_premise_term(&premises[0])?;
    let (phi_1, phi_2) = match_term_flat_err!((not (= phi_1 phi_2)) = premise_term)?;
    assert_eq(phi_1, &conclusion[0])?;
    assert_eq(phi_2, &conclusion[1])
}
...
pub fn ite1(RuleArgs { conclusion, premises, .. }: RuleArgs) -> RuleResult {
    ...
    assert_clause_len(conclusion, 2)?;
    let premise_term = get_premise_term(&premises[0])?;
    let (phi_1, _, phi_3) = match_term_flat_err!((ite phi_1 phi_2 phi_3) = premise_term)?;
    assert_eq(phi_1, &conclusion[0])?;
...
pub fn ite2(RuleArgs { conclusion, premises, .. }: RuleArgs) -> RuleResult {
    ...
    assert_clause_len(conclusion, 2)?;
    let premise_term = get_premise_term(&premises[0])?;
    let (phi_1, phi_2, _) = match_term_flat_err!((ite phi_1 phi_2 phi_3) = premise_term)?;
    assert_eq(phi_1, conclusion[0].remove_negation_err()?)?;
    assert_eq(phi_2, &conclusion[1])
}
...
pub fn not_ite1(RuleArgs { conclusion, premises, .. }: RuleArgs) -> RuleResult {
    ...
    assert_clause_len(conclusion, 2)?;
    let premise_term = get_premise_term(&premises[0])?;
    let (phi_1, _, phi_3) = match_term_flat_err!((not (ite phi_1 phi_2 phi_3)) = premise_term)?;
    assert_eq(phi_1, &conclusion[0])?;
...
pub fn not_ite2(RuleArgs { conclusion, premises, .. }: RuleArgs) -> RuleResult {
    ...
    assert_clause_len(conclusion, 2)?;
    let premise_term = get_premise_term(&premises[0])?;
    let (phi_1, phi_2, _) = match_term_flat_err!((not (ite phi_1 phi_2 phi_3)) = premise_term)?;
    assert_eq(phi_1, conclusion[0].remove_negation_err()?)?;
    assert_eq(phi_2, conclusion[1].remove_negation_err()?)
}
...
pub fn ite_intro(RuleArgs { conclusion, polyeq_time, .. }: RuleArgs) -> RuleResult {
    ...
    let (root_term, right_side) = match_term_flat_err!((= t u) = &conclusion[0])?;
    ...
    let us = match_term_flat_err!((and ...) = right_side)?;
    ...
    for u_i in &us[1..] {
        let (cond, a, b, c, d) = match_term_flat_err!((ite cond (= a b) (= c d)) = u_i)?;
...
pub fn connective_def(RuleArgs { conclusion, .. }: RuleArgs) -> RuleResult {
    ...
    let (first, second) = match_term_flat_err!((= f s) = &conclusion[0])?;

    if let Some((phi_1, phi_2)) = match_term!((xor phi_1 phi_2) = first) {
        // phi_1 xor phi_2 <-> (¬phi_1 ^ phi_2) v (phi_1 ^ ¬phi_2)
        let (a, b, c, d) = match_term_flat_err!((or (and (not a) b) (and c (not d))) = second)?;
        assert_eq(a, phi_1)?;
        assert_eq(b, phi_2)?;
        assert_eq(c, phi_1)?;
        assert_eq(d, phi_2)
        ...
        let (a, b, c, d) = match_term_flat_err!((and (=> a b) (=> c d)) = second)?;
        assert_eq(a, phi_1)?;
        assert_eq(b, phi_2)?;
        assert_eq(c, phi_2)?;
        assert_eq(d, phi_1)
        ...
        let (a, b, c, d) = match_term_flat_err!((and (=> a b) (=> (not c) d)) = second)?;
        assert_eq(a, phi_1)?;
        assert_eq(b, phi_2)?;
        assert_eq(c, phi_1)?;
        assert_eq(d, phi_3)
    } else if let Some((first_bindings, first_inner)) = match_term!((forall ... f) = first) {
        let (second_bindings, second_inner) = match_term_flat_err!((not (exists ... (not s))) = second)?;
        ...
        let (second_bindings, second_inner) = match_term_flat_err!((not (forall ... (not s))) = second)?;
        assert_eq(first_inner, second_inner)?;
        assert_eq(first_bindings, second_bindings)
    } else {
