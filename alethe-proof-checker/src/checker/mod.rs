...
impl<'c> ProofChecker<'c> {
    ...
    pub fn get_rule(rule_name: &str) -> Option<Rule> {
        ...
        Some(match rule_name {
            ...
            "eq_reflexive" => to_new_format!(reflexivity::eq_reflexive),
            "eq_transitive" => to_new_format!(transitivity::eq_transitive),
            "eq_congruent" => to_new_format!(congruence::eq_congruent),
            "eq_congruent_pred" => to_new_format!(congruence::eq_congruent_pred),
